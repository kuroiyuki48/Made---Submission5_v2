...
public class RecyclerAiringTodayAdapter extends RecyclerView.Adapter<RecyclerAiringTodayAdapter.ViewHolder> {

    private static final String TAG = "RecyclerAiringAdapter";
    ...
    public RecyclerAiringTodayAdapter(Context mContext, List<MovieResult> moviesItem) {
