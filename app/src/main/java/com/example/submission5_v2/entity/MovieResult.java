...
public class MovieResult implements Parcelable {
    ...
    public String getMovieAiring() {
        return movieAiring;
    }

    public void setMovieAiring (String movieAiring) {
        this.movieAiring = movieAiring;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.movieAiring);
    ...
    protected MovieResult(Parcel in) {
        ...
        this.movieAiring = in.readString();
